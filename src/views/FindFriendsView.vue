<template>
     <div id="FindFriends" class="pt-[100px] overflow-auto fixed h-[100vh] w-full">
           ...
           <div v-for="user in userComputed" :key="user">
            <div v-if="hideMe(user)" @click="createNewChat(user)" class="flex w-full p-4  intems-center cursor-pointer">
                
                <img class="rounded-full mr-4 w-12 h-12" :src="user.picture || ''" alt="Sample Image">
