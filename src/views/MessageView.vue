                ...
                <div class="bg-[#F0F0F0] fixed z-10 min-w-[calc(100vw-420px)] flex justify-between items-center px-2 py-2">
                    <div class="flex items-center">
                        <img
                         ...
                         class="rounded-full mx-1 w-10 " :src="userDataForChat[0].picture" alt="Sample Image">
                        <div
            ...
            <div id="MessagesSection" class="pt-20 pb-8 z-[-1] h-[calc(100vh-65px)] w-[calc(100vw-420px)] overflow-auto fixed touch-auto">
             ...
             <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg[#F0F0F0] fixed bottom-0">
                <div class="flex itmes-center justify-center">
                   ...
                   @click="sendMessage" class="ml-3 p-2 w-12 flex items-center justify-center">
...
<style>
#BG{
    background: url('../assets/message-bg.png') no-repeat center;
    width: 100%;
    height: 100%;
    position: fixed;
    z-index: -1;
