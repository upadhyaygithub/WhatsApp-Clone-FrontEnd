<template>
   <div class="flex">
    <div id="Header" class="fixed w-[420px] z-10">
      <div class="bg-[#F0F0F0] w-full flex justify-between items-center px-3 py-1">
        <img class="rounded-full ml-1 w-10 h-10" :src="userStore.picture || ''" alt="Sample Image">
      ...
      <div id="Search" class="bg-white w-full px-2  border-b shadow-sm">
        <div class="px-1 m-2 bg-[#F0F0F0] flex item-center justify-center justify-between rounded-md">
          <MagnifyIcon fillColor="#515151" :size="18" class="ml-2 mt-1.5" />
          <input
        ...
        <div class="grid h-screen place-items-center">
            <div>
                <div class="w-full flex items-center justify-center">
                    <img width="375" src="../assets/w-web-not-loaded-chat.png" alt="Sample Image">
                </div>
                <div class="text-[32px] text-gray-500 font-light mt-5 text-center">WhatsApp Web</div>
